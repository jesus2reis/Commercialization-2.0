...
export const PILLARS: PillarDefinition[] = [
  {
    id: 'hd',
    name: 'HD (Hemodialysis Core)',
    sheetName: 'HD',
    shortName: 'HD Core',
    tagline: 'Standard & high-efficiency hemodialysis machines and essential disposables',
    description: 'Foundational 4008 series platforms, Bibag dry bicarbonate cartridges, FX Classix dialyzers, and extracorporeal bloodline tubing sets.',
    color: 'bg-[#7ecedf]',
  ...
  {
    id: 'hvhdf',
    name: 'HvHDF (High-Volume Hemodiafiltration)',
    sheetName: 'HvHDF',
    shortName: 'HvHDF',
    tagline: 'Cardioprotective high-volume therapy, advanced Helixone membranes & ultrapure water',
    description: 'FX CorAL HD dialyzers with nano-hydro membrane technology, double-stage reverse osmosis water treatment (AquaBplus/Saubern), and DIASAFEplus endotoxin ultrafiltration.',
    color: 'bg-[#377cb5]',
  ...
  {
    id: 'personalization',
    name: 'Personalization & Trading Goods',
    ...
    description: 'Ergonomic treatment chairs (ETC-1B, PY-SOY), high-flow Light Needles, Easy On/Easy Off Finesse connection sets, and prefilled Steriset/MedXL flush and lock syringes.',
    color: 'bg-[#071b45]',
  ...
  },
  {
    ...
    description: '7Connect clinic data bridge and full-scale TDMS (Therapy Data Management System) software integrating treatment parameters across machines.',
    color: 'bg-[#089e9a]',
  ...
  {
    id: 'services',
    name: 'Services & Clinical Consultancy',
    sheetName: 'Services',
    shortName: 'Services',
    tagline: 'Technical engineering SLAs, preventive maintenance, and expert clinical consultancy',
    description: 'Certified biomedical technical support, guaranteed spare parts availability, and application consultancy for clinical staff onboarding and workflow optimization.',
    color: 'bg-[#a8a39d]',
  ...
  {
    id: 'sustainability',
    name: 'Sustainability & Fluid Management',
    ...
    description: 'Granumix+ CDS central concentrate mixing reducing plastic canister waste, Smartbag automated supply, and biodegradable Citrosteril/Puristeril thermal-chemical disinfection.',
    color: 'bg-[#8bc53f]',
